...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet result1 = stmt1.executeQuery("select* from acount_musyrifah where userid='" + userid_txt.getText() + "' and password='" + pass_txt.getText() + "'");

            if (result.next()) {

                JOptionPane.showMessageDialog(null, "Log In Sukses");
                main.setUser(userid_txt.getText());
                main.setSebagai("admin");
